...
public class Second_Highest_In_BST {
  ...
  public static int findSecondLargest(BinaryTreeNode rootNode) {
    ...
    while(true) {
      ...
      if(rootNode.right != null && rootNode.right.right == null && rootNode.left!=null && rootNode.left.left == null) {
  ...
  public static void main(String[] args) {
    Result result = JUnitCore.runClasses(Second_Highest_In_BST.class);
