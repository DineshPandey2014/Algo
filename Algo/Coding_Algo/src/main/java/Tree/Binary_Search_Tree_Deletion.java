package Tree;
   ...
   class TreeNodeBSTDeletion {
     int val;
     TreeNodeBSTDeletion left;
     TreeNodeBSTDeletion right;
     TreeNodeBSTDeletion(int x) { val = x; }
   }
...
public class Binary_Search_Tree_Deletion {
  ...
  public TreeNode deleteNode(TreeNode root, int key) {
    ...
    if (root.val == key) {
      ...
      root.val = p.val;
      // Now the deletion will happened from the right side of the tree as we swap the value.
      // We need to updated the root right node.
